...
public class PlayerStateManager : MonoBehaviour
{
    ...
    // Movement and combat parameters (tweak these as needed)
    ...
    private void Awake()
    {
        // Get references from the GameObject.
    ...
    private void Update()
    {
        ...
        // If not in Attack state, update movement and jump/gravity.
    ...
    public bool IsAttackAnimationFinished()
    {
        if (Animator != null)
        {
            ...
            // "Attack" must match the name of the attack state in your Animator.
            return stateInfo.IsName("Attack") && stateInfo.normalizedTime >= 1f;
        }
        return true;
    }

    // A simple grounded check. Replace with your own physics logic as needed.
    public bool IsGrounded()
    {
        return isGrounded;
    }

    // Extracted movement logic (adapted from ThirdPersonController)
    ...
    // Extracted jump and gravity logic.
